        ...
        static void Main()
        {
            ...
            */
            var WebServiceEndpoints = new List<BWebPrefixStructure>()
            {
                ...
                new BWebPrefixStructure(new string[] { "/auth/users/*/access_methods/*/access_rights/grant_base_access_rights" }, () => new User_GrantBaseAccessRights_ToAccessMethod_ForUser(ServInit.DatabaseService, ServInit.MemoryService, "users", "access_methods")),
                new BWebPrefixStructure(new string[] { "/auth/users/*/access_methods/*/access_rights/*" }, () => new User_UpdateDeleteRight_ForAccessRight_ForUser(ServInit.DatabaseService, ServInit.MemoryService, "users", "access_methods", "access_rights")),
                new BWebPrefixStructure(new string[] { "/auth/users/*/access_methods/*/access_rights" }, () => new User_AddListRights_ForAccessRight_ForUser(ServInit.DatabaseService, ServInit.MemoryService, "users", "access_methods")),
